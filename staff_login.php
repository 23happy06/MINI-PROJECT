...
<head>
    ...
    <title>Talent Track - Staff Login</title>
...
<body>
    <header>
        <div class="logo">
            <i class="fas fa-user-tie"></i> Talent Track
        </div>
    ...
    <div class="login-box">
        ...
        <form method="POST" action="">
            <div class="input-container">
                ...
                <input type="text" name="username" placeholder="Staff Username" required autocomplete="username" />
            </div>
            <div class="input-container">
